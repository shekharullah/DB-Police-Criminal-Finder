...
def blank(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Admin.blank(), HandlerDef(this.getClass.getClassLoader, "", "controllers.Admin", "blank", Seq(), "GET", """""", _prefix + """admin""")
)
...
// @LINE:49
def blank(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Dashboard.blank(), HandlerDef(this.getClass.getClassLoader, "", "controllers.Dashboard", "blank", Seq(), "GET", """ Admin""", _prefix + """dashboard""")
)
